...
from const_KH_instability import *



current_path = os.getcwd()
if not os.path.exists(current_path + '/results_KH_instability'):
    os.mkdir('results_KH_instability')
...
for k in range(step+1):
    ...
    #v, x = periodic_condition_KH_x(x_max, v, x)
    #v, x = periodic_condition_KH_y(y_max, v, x)
    #STEP5
    ...
    if k % 100 == 0:
        ...
        np.save(f'results_KH_instability/results_2pic_KH_instability_xv_{k1}.npy', np.concatenate([x, v]))
        np.save(f'results_KH_instability/results_2pic_KH_instability_E_{k1}.npy', E)
        np.save(f'results_KH_instability/results_2pic_KH_instability_B_{k1}.npy', B)
        np.save(f'results_KH_instability/results_2pic_KH_instability_current_{k1}.npy', current)
        np.save(f'results_KH_instability/results_2pic_KH_instability_KE_{k1}.npy', KE)
